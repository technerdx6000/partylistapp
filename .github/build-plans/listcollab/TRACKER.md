...
| 4 – API | 4.2 | Connection pool, `withTransaction`, repository layer | 🔄 In Progress | Replacing the legacy direct-SQL route access with a typed pool module and event-scoped repositories before the token middleware and new routes land |
