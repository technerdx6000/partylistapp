...
| 1 – Stabilise | 1.7 | Reproducible Docker dev environment + `DEVELOPMENT.md` | ⬜ Not Started | |
| 2 – Foundation | 2.1 | npm workspaces + Turborepo pipelines and root scripts | ⬜ Not Started | |
| 2 – Foundation | 2.2 | Relocate apps to `apps/web` and `apps/api` with `git mv` | ⬜ Not Started | Update Compose paths |
| 2 – Foundation | 2.3 | `packages/tsconfig` — base, node, react configs | ⬜ Not Started | |
| 2 – Foundation | 2.4 | Create `packages/shared` with Zod + `calculateCoverage` | ⬜ Not Started | |
| 2 – Foundation | 2.5 | Convert the API to TypeScript (no restructuring) | ⬜ Not Started | |
